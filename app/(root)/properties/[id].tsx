...
const Property = () => {
  ...
  // Provide default empty arrays for potentially missing properties
      ...
      >
        ...
        <View className="px-5 mt-7 flex gap-2">
          ...
          <View className="flex flex-row items-center gap-3">
            ...
            <View className="flex flex-row items-center gap-2">
              ...
              <Text className="text-black-200 text-sm mt-1 font-rubik-medium">
                {/* FIX: Use the safe 'reviews' variable */}
          ...
          <View className="w-full border-t border-primary-200 pt-7 mt-5">
            ...
            <View className="flex flex-row items-center justify-between mt-4">
              <View className="flex flex-row items-center">
                {/* FIX: Use optional chaining for agent and avatar */}
                <Image
          ...
          <View className="mt-7">
            ...
            {/* FIX: Use the safe 'facilitiesList' variable */}
            {facilitiesList.length > 0 && (
              <View className="flex flex-row flex-wrap items-start justify-start mt-2 gap-5">
                {facilitiesList.map((item: string, index: number) => {
          ...
          {/* FIX: Use the safe 'gallery' variable */}
          {gallery.length > 0 && (
            <View className="mt-7">
              <Text className="text-black-300 text-xl font-rubik-bold">
                Gallery
          ...
          {reviews.length > 0 && (
            <View className="mt-7">
              ...
              <View className="mt-5">
                {/* FIX: Safely access the first review */}
